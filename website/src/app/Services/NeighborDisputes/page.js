  ...
  return (
    <>
      ...
      <div className="nd-page">
        ...
        {/* ══ HOW IT WORKS ══ */}
        <section ref={hiwRef} className={`nd-hiw-wrap hiw-section${hiwVisible ? " hiw-animate" : ""}`}>
          <div className="hiw-header">
            <p className="hiw-eyebrow">3 SIMPLE STEPS</p>
            <h2 className="hiw-title">Still Not Resolved? Try Neighbor Dispute Mediation</h2>
