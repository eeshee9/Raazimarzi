...
export default function HomePage() {
  ...
  useEffect(() => makeObs(setHiwVisible)(hiwRef.current),     []); // ← fixed: was using unused `setHiwIn`
  useEffect(() => {
    ...
    <>
      ...
      <section className="hero-wrapper">
        ...
        <svg className="hero-connectors" aria-hidden="true" viewBox="0 0 1440 820" preserveAspectRatio="none">
          <path d="M 296 195 C 420 195, 520 290, 620 340" fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="1.8" strokeDasharray="8 6" strokeLinecap="round" />
          <path d="M 296 415 C 390 415, 500 390, 610 375" fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="1.8" strokeDasharray="8 6" strokeLinecap="round" />
          <path d="M 1144 195 C 1020 195, 920 290, 820 340" fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="1.8" strokeDasharray="8 6" strokeLinecap="round" />
          <path d="M 1144 415 C 1050 415, 940 390, 830 375" fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="1.8" strokeDasharray="8 6" strokeLinecap="round" />
        </svg>

        <div className="hero-cards">
          <div className="hero-card hero-card-1">
            <div className="hero-card-top">
              <div className="hero-card-icon"><img src="/assets/icons/home-i1.png" alt="" aria-hidden="true" /></div>
          ...
          <div className="hero-card hero-card-2">
            <div className="hero-card-top">
              <div className="hero-card-icon"><img src="/assets/icons/home-i2.png" alt="" aria-hidden="true" /></div>
          ...
          <div className="hero-card hero-card-3">
            <div className="hero-card-top">
              <div className="hero-card-icon"><img src="/assets/icons/home-i3.png" alt="" aria-hidden="true" /></div>
          ...
          <div className="hero-card hero-card-4">
            <div className="hero-card-top">
              <div className="hero-card-icon"><img src="/assets/icons/home-i4.png" alt="" aria-hidden="true" /></div>
