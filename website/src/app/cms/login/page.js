...
// SEO team login page — visit at localhost:3000/cms/login
...
export default function CmsLogin() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8fafc', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <div style={{ width: '100%', maxWidth: 400, background: '#fff', borderRadius: 16, border: '1px solid #e2e8f0', padding: '36px 32px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
        ...
        {/* Error */}
        {error && (
          <div style={{ background: '#fee2e2', color: '#dc2626', padding: '10px 12px', borderRadius: 8, fontSize: 13, marginBottom: 16, border: '1px solid #fca5a5' }}>
            {error}
          </div>
        )}
